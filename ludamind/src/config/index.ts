...
import { SchemaPermissions, MultiDatabaseConfig } from "../types/index.js";
import { MongoDBConfig } from "../types/mongodb-connections.js";
import { parseSchemaPermissions, loadDatabasesFromEnv } from "../utils/index.js";
import { loadMongoDBsFromEnv } from "../utils/mongodb-connection-parser.js";

export const MCP_VERSION = "2.0.8";

// @INFO: Load environment variables from .env file
dotenv.config();

// Load multi-database configuration from environment (MySQL)
export const multiDbConfig: MultiDatabaseConfig = loadDatabasesFromEnv(
  process.env as Record<string, string | undefined>
);

// Load MongoDB configurations from environment
export const mongoDbConfigs: Map<string, MongoDBConfig> = loadMongoDBsFromEnv(
  process.env as Record<string, string | undefined>
);
...
export const mcpConfig = {
  server: {
    name: "@trendspro/mcp-server-unified-db",
    version: MCP_VERSION,
